...
let answers1 = ["なべ","ナベ","鍋"];
let answers2 = ["圧","あつ"];
let answers3 = ["なべあつ","ナベアツ","世界のナベアツ","世界のなべあつ","せかいのなべあつ", "せかいのナベアツ"];
let hintMessage = "基本は一枚謎ですが、3の倍数と3の付く数字のパネルだけ和同開珎になっています。一枚謎は「もつ、ひ、かも、ど、ぎゅう、ちげ、よせ」に続く言葉を考えることで「鍋」という答えを導くことができます。和同開珎は、頑張って解くと「圧」が答えとなります。どちらかを選んで解きましょう";
